# Minimal Variational Quantum Autoencoder Experiment

This folder contains a small proof-of-concept experiment for validating a
two-qubit Variational Quantum Autoencoder (VQAE) before using real
